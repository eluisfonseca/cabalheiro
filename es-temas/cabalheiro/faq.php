<?PhP
    ...
    echo '<link href="' . SITE_ROOT . '/es-temas/' . config(1) . '/css/faq.css" rel="stylesheet">';
?>
</head>
        ...
        <div class="container recent-container">
            <div class="recent-body">
                    <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2" id="page-container">
                        <div id="faq-content-container" class="col-xs-12">
                            <div class="clear-b faq-header-container">
                                <h2>F.A.Q.</h2>
                            </div>
                            <?PhP
                                printFaq();
