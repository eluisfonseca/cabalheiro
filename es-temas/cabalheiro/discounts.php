<?PhP
    ...
    echo '<link href="' . SITE_ROOT . '/es-temas/' . config(1) . '/css/discounts.css" rel="stylesheet">';
?>
</head>
        ...
        <div class="container recent-container">
            <div class="recent-body ">
                    <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2" id="page-container">
                        <div id="disc-content-container" class="col-xs-12">
                            <div class="clear-b disc-header-container">
                                <h2>Discounts</h2>
                            </div>
                            <h4>These brands and stores where all nice enough to be our friends. When you get there, tell them I sent ya.</h4>
                            <?PHP
                                printDiscounts();
                            ?>
