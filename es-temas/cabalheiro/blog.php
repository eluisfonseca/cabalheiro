    ...
    <section class="header recent">
        <div class="container recent-container">
            <div class="recent-body">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2" id="page-container">
                        <div id="arc-content-container" class="col-xs-12 col-sm-8">
                        ...
                        <div id="right-side-container" class="col-xs-12 col-sm-4">
                            <?php printAdd(3) ?>
                            <div id="right-side-newsletter-container" class="col-xs-12 col-sm-6 col-md-12 clear-padding clear-margin">
                            ...
                            <div id="right-side-follow-container" class="col-xs-12 col-sm-6 col-md-12 clear-padding clear-margin">
                                <div class="footer-col col-xs-12 clear-margin clear-padding">
