    ...
    <section class="header recent">
        <div class="container recent-container">
            <div class="recent-body col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                    <div class="col-xs-12" id="post-video-container">
                        <div class="col-xs-12 recent-text clear-padding">
                            <?Php
                                getVideoFrame();
                            ?>
                        </div>
                    </div>
                    <div class="col-xs-12" id="page-container">
                        <div id="post-content-container" class="clear-padding col-xs-12">
                        <?Php getNoticia()?>
                        </div>
                        <div id="right-side-container" class="col-xs-12 post-right-side-container">
                            <?php printAdd(9) ?>
