...
function getMaxVideoThumbnailByUrl($url, $format = 'small')
{
    if (false !== ($id = getVimeoId($url))) {
        $hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/$id.php"));
        /**
...
EEE;*/
    if (false !== ($id = getDailyMotionId($url))) {
        $code .= <<<EEE
<div class="videoWrapper"><iframe src='http://www.dailymotion.com/embed/video/$id' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
EEE;
    }
    elseif (false !== ($id = getVimeoId($url))) {
        $code .= <<<EEE
<div class="videoWrapper"><iframe src='http://player.vimeo.com/video/$id' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
EEE;
    }
    elseif (false !== ($id = getYoutubeId($url))) { //?fs=1?html5=1
        $code .= <<<EEE
<div class="videoWrapper"><iframe width="560" height="315" src='http://www.youtube.com/embed/$id' frameborder='0' controls='1' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
EEE;
    }
    else {
        $code = false;
